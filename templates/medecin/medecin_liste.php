          ...
          <div class="modal-body">
            ...
            <div class="row md-3">
              <div class="col-12 col-md-6">
                ...
                <select class="form-control"  required name="sexe" list="datalistOptions" id="exampleDataList" placeholder="Ex: sexe">
                  <option value="Homme">
                    Homme
                  </option>
                  <option value="Femme">
              ...
              <div class="col-12 col-md-6">
                ...
                <input class="form-control" list="specialisations" name="specialisation" placeholder="specialisation">
          ...
          foreach ($medecins as $medecin) {
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="/medecin/'.$medecin['id'].'" class="btn btn-primary">Voir plus</a>
              </td>
            </tr>
            ';
          }
